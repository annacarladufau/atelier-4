...
```{r}
 nutriage <- read.csv("~/Desktop/1ère année/1er semestre/biostatistique et méthode scientifique/biostatistique/ateliers/atelier 4/nutriage.csv")
names(nutriage)
```
...
```
le logarithme de la taille suit une distribution normale. 
